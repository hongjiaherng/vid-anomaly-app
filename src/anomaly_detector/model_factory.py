...
CKPT_PATHS = {
    "HL-Net": {
        "C3D": os.path.join(ROOT_PATH, "pretrained", "detector", "pengwu_net_c3d.pth"),
        "I3D": os.path.join(ROOT_PATH, "pretrained", "detector", "pengwu_net_i3d.pth"),
        "Video Swin": os.path.join(ROOT_PATH, "pretrained", "detector", "pengwu_net_swin.pth"),
    },
    "Sultani-Net": {
        "C3D": os.path.join(ROOT_PATH, "pretrained", "detector", "sultani_net_c3d.pth"),
        "I3D": os.path.join(ROOT_PATH, "pretrained", "detector", "sultani_net_i3d.pth"),
        "Video Swin": os.path.join(ROOT_PATH, "pretrained", "detector", "sultani_net_swin.pth"),
    },
    "SVM Baseline": {
        "C3D": os.path.join(ROOT_PATH, "pretrained", "detector", "svm_baseline_c3d.pth"),
        "I3D": os.path.join(ROOT_PATH, "pretrained", "detector", "svm_baseline_i3d.pth"),
        "Video Swin": os.path.join(ROOT_PATH, "pretrained", "detector", "svm_baseline_swin.pth"),
    },
}
...
def build_model(model_name: Literal["HL-Net", "Sultani-Net", "SVM Baseline"], feature_name: Literal["C3D", "I3D", "Video Swin"]):
    ...
    ckpt_path = CKPT_PATHS[model_name][feature_name]
